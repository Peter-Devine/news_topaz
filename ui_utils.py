...
# from IPython.display import display
from ipywidgets import HBox, VBox, Label, Button, AppLayout, Dropdown, Layout, Text, HTML, Box
...
def get_info_bar():
    ...
    lab = HTML(value=get_subheader_value("Please input a keyword above"), layout=Layout(width='100%', height="100%", padding="0px 0px 0px 20px"))
#     lab = Label(value=get_h1_value("Yoooo"), layout=Layout(width='100%', height="100%"))

#     lab.style.font_size = "99px"
...
search_bar = get_search_bar(search_function)
display_box = VBox([search_bar, info_bar])
...
#     date_text.add_class("ms-5")
#     date_text.add_class("pt-2")
#     date_text.add_class("my-0")
#     date_text.add_class("h-100")
